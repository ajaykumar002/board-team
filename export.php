...
$headings = ["Id","Club Name","Name","Call Name","Type","Food Prefrence","Mobile","Transaction Ref.","Designation","Collar Size"];
$data = [];
array_push($data, $headings);
foreach($fetchParticipantsData as $row){
    $dataRow = array($row['id'],$row['clubName'],$row['name'],$row['callName'],$row['type'],$row['foodPrefrence'],$row['mobile'],$row['transaction_ref'],$row['designation'],$row['collar_size']);
